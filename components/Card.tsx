    ...
    return (
        <>
            <div className="justify-items-center w-full my-10 min-h-fit rounded-lg">
                <div className="justify-items-center flex md:flex-row flex-col h-full border border-gray-700 rounded-lg">
                    <Link href={`/post/${slug}`} className="shrink-0 w-full md:w-64 h-56 md:h-48 relative rounded-lg">
